...
<div class="wrapper">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="nav navbar-nav navbar-center" data-in="fadeIn" data-out="fadeOut">
          ...
          <li><a class="page-scroll" href="home-blog.html">Blogs</a></li>
 ...
 <section class="white-bg">
   <div class="container">
     <div class="row blog-style-01">
       <div class="col-md-4 col-sm-4 col-xs-12">
         <div class="post">
           <div class="post-img">
             <img class="img-responsive" src="{{ asset('themeHome/images/post/post-01.jpg') }}" alt=""/>
       ...
       <div class="col-md-4 col-sm-4 col-xs-12">
         <div class="post">
           <div class="blog-grid-slider slick">
             <img class="img-responsive" src="{{ asset('themeHome/images/post/post-02.jpg') }}" alt=""/>
             <img class="img-responsive" src="{{ asset('themeHome/images/post/post-08.jpg') }}" alt=""/>
             <img class="img-responsive" src="{{ asset('themeHome/images/post/post-09.jpg') }}" alt=""/>
           </div>
           <div class="post-metas">
             <div class="post-metas-center">
       ...
       <div class="col-md-4 col-sm-4 col-xs-12">
         <div class="post">
           <div class="post-img">
             <img class="img-responsive" src="{{ asset('themeHome/images/post/post-03.jpg') }}" alt=""/>
             <div class="post-metas">
               <div class="post-metas-center">
   ...
   <div class="row">
     <div class="col-md-4 col-sm-4 col-xs-12">
       <div class="post">
         <div class="post-img">
           <img class="img-responsive" src="{{ asset('themeHome/images/post/post-04.jpg') }}" alt=""/>
           <div class="post-metas">
             <div class="post-metas-center">
         ...
         <div class="post-img">
           <div class="fit-videos">
            <video autoplay="" muted="" loop="" controls="">
              <source src="{{ asset('themeHome/videos/parallax-video.mp4') }}" type="video/mp4">
            </video>
           </div>
     ...
     <div class="col-md-4 col-sm-4 col-xs-12">
       <div class="post">
         <div class="post-img">
           <img class="img-responsive" src="{{ asset('themeHome/images/post/post-06.jpg') }}" alt=""/>
           <div class="post-metas">
             <div class="post-metas-center">
 ...
 <!--== Blog Start ==-->
 <section style="background:url(assets/images/background/stars-bg-3.png) center bottom no-repeat #24182e;">
   <div class="container">
     <div class="row blog-style-01">
       <div class="col-md-4 col-sm-4 col-xs-12">
         <div class="post">
          ...
          <div class="col-sm-3 col-md-4">
            <div class="widget widget-text">
              <div class="logo-footer xs-centerize-col xs-text-center">
                <a href="index.html"><img class="img-responsive" src="{{ asset('themeHome/images/logo-footer.png') }}" alt=""></a>
              </div>
            </div>
          </div>
