...
<body id="page-top">
    ...
    <div id="wrapper" >
        ...
        <!--  Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar Start-->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{URL_ADMIN_HOME}}">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL_LOGOUT}}">Logout</a>
                        <a class="collapse-item" href="register.html">Register Admin</a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{URL_ADMIN_CONTENT_LIST}}">
                    <i class="fas fa-fw fa-list"></i>
                    <span>All content</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{URL_ADMIN_CREATE_NEW_CONTENT}}">
                    <i class="fas fa-fw fa-list"></i>
        ...
        <!--  Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar . Sidebar   END-->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle"  id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('adminPage/img/undraw_profile.svg') }}">
                            </a>
                ...
                <!-- ========================================================================================================================================================= -->
                <!-- ========================================================================================================================================================= -->
                <!-- PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT . PAGE CONTENT START -->
